...
import com.video.upload.app.data.FrameToRecord;
import com.video.upload.app.data.RecordFragment;
import com.video.upload.app.db.SqlDatabase;
import com.video.upload.app.db.Videofile;
import com.video.upload.app.util.CameraHelper;
import com.video.upload.app.util.MiscUtils;
...
//            mProgressDialog.setProgress(values[0]);
    ...
    class FinishRecordingTask extends ProgressDialogTask<Void, Integer, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            SqlDatabase sqlDatabase=new SqlDatabase(FFmpegRecordActivity.this);
            Videofile videofile=new Videofile(mVideo.getPath(),"NO");
            sqlDatabase.addVideo(videofile);
